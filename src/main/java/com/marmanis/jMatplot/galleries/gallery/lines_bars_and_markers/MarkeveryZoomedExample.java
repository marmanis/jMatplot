...
/**
 * jMatplot equivalent of the "zoomed plots" group from the matplotlib
 ...
 *
 * <p>Renders the same curve as the linear group, zoomed in to a small
 * window of the x/y range, with the same nine {@code markevery} cases
 * applied — useful for inspecting exactly which points get marked.
 */
public class MarkeveryZoomedExample {
    ...
    /**
     * Build and return the markevery-with-zoomed-plots figure.
     *
    ...
    public static Figure createFigure() {
        ...
        for (int r = 0; r < rows; r++) {
            for (int c = 0; c < cols; c++) {
                ...
                ax.setXLim(6, 6.7);
                ax.setYLim(1.1, 1.7);
                ax.setTitle("markevery=" + CASE_LABELS[idx] + " (zoomed)");
