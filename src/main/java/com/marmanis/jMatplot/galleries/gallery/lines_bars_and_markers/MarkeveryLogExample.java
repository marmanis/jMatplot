...
/**
 * jMatplot equivalent of the "log scale" group from the matplotlib
 ...
 *
 * <p>Renders the same curve as the linear group, but on log-log axes, with
 * the same nine {@code markevery} cases applied.
 */
public class MarkeveryLogExample {
    ...
    /**
     * Build and return the markevery-with-log-scales figure.
     *
    ...
    public static Figure createFigure() {
        ...
        for (int r = 0; r < rows; r++) {
            for (int c = 0; c < cols; c++) {
                ...
                ax.setLogScale(true, true);
                ax.setTitle("markevery=" + CASE_LABELS[idx] + " (log)");
