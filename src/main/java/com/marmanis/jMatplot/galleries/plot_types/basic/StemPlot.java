 ...
 * <p>Java equivalent of {@code galleries/plot_types/basic/stem.py}</p>
 *
 * @see com.marmanis.jMatplot.core.Axes
 */
public class StemPlot implements GalleryExample {
    ...
    public static void main(String[] args) {
        Figure fig = new StemPlot().create();
