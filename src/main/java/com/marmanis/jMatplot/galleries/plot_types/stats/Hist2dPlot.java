 ...
 * <p>Java equivalent of {@code galleries/plot_types/stats/hist2d.py}</p>
 *
 * @see com.marmanis.jMatplot.core.Axes
 */
public class Hist2dPlot implements GalleryExample {
    ...
    public static void main(String[] args) {
        Figure fig = new Hist2dPlot().create();
